# AI Systems, Automation & SaaS Portfolio

<div align="center">

### Alejandro Aguirre Laprea
**AI Adoption & Transformation Consultant · AI Systems Architect**

Porto, Portugal · Remote / International

[LinkedIn](https://www.linkedin.com/in/alejandro-jose-aguirre-laprea-2236a4126/) · [GitHub](https://github.com/lapreale)
...
|---|---|
| **Frontend** | React, TypeScript, JavaScript, HTML/CSS, Vite, Tailwind CSS, Radix UI |
...
## 1. ZORDON — Multi-Agent AI Orchestration Platform
A self-hosted orchestration architecture for coordinating specialized AI agents, multiple model providers and operational tools from a central control layer.

**What it demonstrates:** AI agents · multi-model routing · tool execution · verification · self-hosted infrastructure · cost-aware AI operations
...
**Stack:** JavaScript · HTML/CSS · Google Workspace APIs · Gmail/Calendar integrations · CRM data model · web app backend services

[View case study →](projects/beauty-operations.md)
...
**Implemented stack:** React · TypeScript · Vite · Firebase · Recharts · PDF/report generation

**Data/AI expansion path:** Python analytics services · SQL warehouse · model-assisted interpretation

[View case study →](projects/football-meta-pro.md)
...
```mermaid
flowchart LR
    A[Business problem] --> B[Process mapping]
    B --> C[Data & integration design]
    C --> D[Automation / AI architecture]
    D --> E[Build & integrate]
    E --> F[Test & verify]
    F --> G[Measure business impact]
    G --> H[Iterate / scale]
```

I start with the **business process**, not the model. AI is introduced only where it improves a measurable part of the workflow.

---

## Architecture principles

1. **Business-first** — solve an operational problem before adding AI.
2. **Human control where it matters** — approvals and escalation for sensitive actions.
3. **Structured data before automation** — reliable workflows need reliable state.
...
## Public portfolio vs. production code

This repository intentionally contains **case studies and sanitized architecture descriptions**, not full production code.

Private repositories may include:
- client-specific workflows and data models
- production endpoints and deployment details
...
**LinkedIn:** https://www.linkedin.com/in/alejandro-jose-aguirre-laprea-2236a4126/  
**GitHub:** https://github.com/lapreale
